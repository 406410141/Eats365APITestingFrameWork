...
def test_TC_TG_001_structure(get_tax_group_response_fixture):
    status_code = get_tax_group_response_fixture.get('status_code', 200)
...
def test_TC_TG_002_content(get_tax_group_response_fixture):
...
def test_TC_TG_003_data(get_tax_group_response_fixture):
    tax_group_list = get_tax_group_response_fixture.get("tax_group_list", [])
    found = False
    for tax_group in tax_group_list:
